...
一般的に、適度なインフレは経済にとって好ましいとされています。物価が将来上昇すると思えば、人々は消費を前倒しするので、景気は刺激されます。しかし、インフレは時間とともに通貨が減価し続けることを意味するので、通貨の[価値貯蔵手段](http://lostinbitcoin.jp.testrs.jp/staging/glossary/sov/)としての機能を損ないます。
